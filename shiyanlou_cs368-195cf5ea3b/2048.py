...
def get_user_action(keyboard):#用户输入处理，直到获得用户有效输入才返回对应行为
    char = "N"
...
class GameField(object):#创建棋盘
    ...
    def draw(self, screen):
        ...
        def draw_hor_separator():#绘制水平分割线
            line = '+' + ('+------' * self.width + '+')[1:]
    ...
    def spawn(self):#棋盘操作，随机生成一个2或者4
...
def main(stdscr):
    ...
    def game():
        ...
        action = get_user_action(stdscr)#读取用户输入得到action
