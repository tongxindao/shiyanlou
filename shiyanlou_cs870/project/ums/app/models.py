...
assoc_teacher_student = Table(
    'teacher_student', Model.metadata,
...
class Student(Model):
    ...
    college_id = Column(Integer, ForeignKey('college.id'), nullable = False) # 学院
    college = relationship("College")
    major_id = Column(Integer, ForeignKey('major.id'), nullable = False) # 专业
    major = relationship("Major")
    mclass_id = Column(Integer, ForeignKey('mclass.id'), nullable = False) # 班级
