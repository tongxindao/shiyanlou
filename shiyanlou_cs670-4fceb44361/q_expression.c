...
lval* builtin_join(lval* a) {
    ...
    while(a->count) { x = lval_join(x, lval_pop(a, 1)); }
...
lval* builtin_head(lval* a) {
    ...
    /* Delete all element that are not head and return */
